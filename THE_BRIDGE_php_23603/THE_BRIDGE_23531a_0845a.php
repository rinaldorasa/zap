...
<!-- THE_BRIDGE_23531_0800a -->
<title>

? T

THE_BRIDGE_23531_0800a.html
...
/* position:sticky;bottom:0rem;left:0rem; */

/* position:sticky;top:0rem; */

position:sticky;top:0rem;

/* background-color:rgb(85,25,225);color:white; */
/*                                              */ 
/* border:solid 0.25rem rgb(85,25,225);         */
/* border-radius:0.50rem;                       */
...
#CHIUDI_QUESTION_MARK_POPUP__:hover{background-color:rgb(138,162,239);border-radius:0.50rem;}

#CHIUDI_QUESTION_MARK_POPUP__ span{
background-color:rgb(85,25,225);color:white;border-radius:0.50rem;
}
...
#CONTENUTO_DI_POPUP__{position:relative;0rem;left:0rem;}
...
<q style="font-size:0.75rem;">THE_BRIDGE_23531_0800a</q>
<span>X</span>
</blockquote>
<q style="position:absolute;bottom:0rem;right:0rem;font-size:0.75rem;">TheRollingThunderProject released THE_BRIDGE_23531_0800a</q>
</article>
...
<!--
<q>Versione <span style="background-color:red;color:white;"></span> </q>
<q style="background-color:green;color:white;font-size:0.75rem;">THE_BRIDGE_23531_0800a</q>
-->

<q>
<ol>
<li><q style="font-size:0.75rem;">( Altezza id HEADER__ ) HeightHeader__=`+ HeightHeader__ +`</q></li>
...
function ColoreEsadecimaleRandom() {
        var LettereColoreRandom__ = '0123456789ABCDEF'.split('');
        var CreaColoreRandom__ = '#';
        for (var IColoreRandom__ = 0; IColoreRandom__ < 6; IColoreRandom__++ ) {
