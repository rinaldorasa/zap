...
' <button type="button" class="btn shadow-none"   '+ 	'    data-toggle="collapse" data-target="#collapsemenuapdp"   '+ 	'    aria-expanded="false"  '+ 	'  style="border-radius:0rem !important; border:solid 0rem black; "> '+ 	'    '+ 	'  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-back" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M0 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v2h2a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-2H2a2 2 0 0 1-2-2V2zm2-1a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H2z"/> '+ 	'  </svg>  '+ 	'    '+ 	
' </button>      '+	 	
...
'  <div id="collapsemenuapdp" class="collapse dropdown-menuY  border-0"   '+ 	'    style="    padding:0rem !important;  '+ 	'   '+ 	
'     background-color:rgba(0,85,85,0);   '+ 	'    border-left:solid 0.1rem rgba(255,170,0,1) !important;   '+ 	
