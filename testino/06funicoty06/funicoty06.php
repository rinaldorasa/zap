...
button{background-color:transparent;border-color:transparent;}
 ...
 #w_a_1_1_UP_DOWN_NELLA_PAGINA{position:fixed; top:25%; top:7.00rem; top:9.00rem; left:0%; width:auto; height:auto;}
 #w_a_1_1_UP_DOWN_NELLA_PAGINA{display:block; z-index:1000000;}
 ...
 #w_a_1_1_CONTENITORE_DETTAGLI_SLIDERS{position:fixed; top:9.00rem; right:0.0rem;  background-color:transparent; background-color:yellow; background-color:rgba(255, 215, 0, 0.125); border:solid 0.00rem red; border-radius:0.35rem;}
...
<!-- qui anomalia, details contiene  -->
<details id="w_a_1_1_DETAILS_TESTO_DINAMICO" class="ui  segment">
<?php  
...
?>
<main id="w_a_1_1_MAIN">
<section id="w_a_1_1_TRASH_PUNTINI_ETC">  
...
</section> <!-- w_a_1_1_TRASH_PUNTINI_ETC -->


<!-- qui si immettono dati e ctrl -->
<!-- sezione self reference dgebi -->
<!-- vuol dire tutto in una linea -->
<section id="w_a_1_1_FORM_X_INVIA__"  class="ui  segment"></section> <!-- w_a_1_1_FORM_X_INVIA__  -->
<?php 
...
echo '<form id="w_a_1_1_FORM_X_INVIA_AES__" action="funicoty06.php" method="POST">';
...
echo '<article id="w_a_1_1_invia_testo_container__" class="ui  segment">';



echo '<button id="w_a_1_1_invia_testo_button__" type="submit" class="ui  green  button">';
...
if(  ($w_a_1_1_post_uno==='ics') or ($w_a_1_1_post_uno==='x')  ){  
echo 'cancellazione file... ' . $w_a_1_1_PHP_FIL_tyng ;
unlink($w_a_1_1_PHP_FIL_tyng);
echo '<script>document.querySelector("#Eseguire_il_LOGIN").style.display="block";</script>';
echo 'Eseguire_il_LOGIN';

}else{};

if(  ($w_a_1_1_post_uno==='uno') or ($w_a_1_1_post_due==='due')  ){  
echo 'creazione file... ' . $w_a_1_1_PHP_FIL_tyng ;

	$w_a_1_1_handle = fopen($w_a_1_1_PHP_FIL_tyng, "w+");
	fwrite($w_a_1_1_handle, $time);
	fclose($w_a_1_1_handle);

echo '<script>document.querySelector("#Eseguire_il_LOGIN").style.display="none";</script>';
...
</details> <!-- w_a_1_1_DETAILS_TESTO_DINAMICO -->
...
release FUNICOTY06_240127_1930a   : verde, nook, sparrow, sixties
 &copy; 2024
</q>
