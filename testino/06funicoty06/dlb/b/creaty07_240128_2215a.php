...
echo '
<article class="ui green center aligned segment">
<div class="ui green button"><h2>' . $NOME_NUOVA_CARTELLA_TY_DOVE_CON_SLASH .   '</h2></div>
</article>
';


echo '<article class="ui red center aligned segment">';

if( is_Dir($NOME_NUOVA_CARTELLA_TY_DOVE_CON_SLASH) ){

echo '<br>';
echo  'La cartella <h3>' . $NOME_NUOVA_CARTELLA_TY_DOVE_CON_SLASH . '</h3><h2><b> esiste </b></h2>';
...
echo '<br>';
echo  'La cartella <h3>' . $NOME_NUOVA_CARTELLA_TY_DOVE_CON_SLASH . '</h3><h2><b> NON esiste </b></h2>';
...
echo '<blockquote style="color:black;" class="ui center aligned segment"> CREATY07_240128_1900a </blockquote>';
echo '<hr>';
...
echo '<br>';
// secondo livello platform

$w_a_1_1_PHP_DIR_platform='w_a_0_0_platform';
$ORIGINE= $CARTELLA_VECCHIA.$w_a_1_1_PHP_DIR_noyek . '/' . $w_a_1_1_PHP_DIR_platform . '/';
$DESTINA= $CARTELLA_NUOVA.$w_a_1_1_PHP_DIR_noyek   . '/' . $w_a_1_1_PHP_DIR_platform . '/';
// occorre provare che esiste
...
echo '<br>';
// secondo livello savecif 

$w_a_1_1_PHP_DIR_savecif='w_a_0_0_savecif';
$ORIGINE= $CARTELLA_VECCHIA.$w_a_1_1_PHP_DIR_noyek . '/' . $w_a_1_1_PHP_DIR_savecif . '/';
$DESTINA= $CARTELLA_NUOVA.$w_a_1_1_PHP_DIR_noyek   . '/' . $w_a_1_1_PHP_DIR_savecif . '/';
// occorre provare che esiste
if(is_Dir($DESTINA)){ echo '<br>'.$DESTINA.' esiste ';}else{ echo '<br>'.$DESTINA.' NON esiste '; mkdir($DESTINA); };
...
// primo livello
// decifra
$ORIGINE= $CARTELLA_VECCHIA.$w_a_1_1_PHP_DIR_decifra.'/';
$DESTINA= $CARTELLA_NUOVA.$w_a_1_1_PHP_DIR_decifra.'/';
...
if(is_Dir($DESTINA)){ echo '<br>'.$DESTINA.' esiste ';}else{ echo '<br>'.$DESTINA.' NON esiste '; mkdir($DESTINA); };
        ...
        $LISTA_FILES = scandir($ORIGINE);
        $CONTA_FILES = count($LISTA_FILES);
        echo '<br>';
//        echo $ORIGINE.' ha '.$CONTA_FILES.' file';
        $OGGETTO = $LISTA_FILES[$CONTA_FILES-1];
...
// primo livello
// cifrato
$ORIGINE= $CARTELLA_VECCHIA.$w_a_1_1_PHP_DIR_cifrato.'/';
$DESTINA= $CARTELLA_NUOVA.$w_a_1_1_PHP_DIR_cifrato.'/';
...
// primo livello
// commenti
$w_a_1_1_PHP_DIR_commenti='w_a_0_0_commenti';
$ORIGINE= $CARTELLA_VECCHIA.$w_a_1_1_PHP_DIR_commenti.'/';
$DESTINA= $CARTELLA_NUOVA.$w_a_1_1_PHP_DIR_commenti.'/';
...
//      $OGGETTO = $LISTA_FILES[$CONTA_FILES-1];
		...
		$OGGETTO= 'w_a_0_0_PAGINA.htm';
        CreaTy($ORIGINE, $DESTINA, $OGGETTO);
		$OGGETTO= 'w_a_0_0_RESTAYLING.html';
        CreaTy($ORIGINE, $DESTINA, $OGGETTO);
		$OGGETTO= 'w_a_0_0_commenti.php';
        CreaTy($ORIGINE, $DESTINA, $OGGETTO);
		$OGGETTO= 'vdir.php';
        CreaTy($ORIGINE, $DESTINA, $OGGETTO);
...
// primo livello
// dlb
$w_a_1_1_PHP_DIR_dlb='dlb';
$ORIGINE= $CARTELLA_VECCHIA.$w_a_1_1_PHP_DIR_dlb.'/';
$DESTINA= $CARTELLA_NUOVA.$w_a_1_1_PHP_DIR_dlb.'/';
...
// secondo livello
// a
$w_a_1_1_PHP_DIR_dlb_a='a';

$ORIGINE= $CARTELLA_VECCHIA.$w_a_1_1_PHP_DIR_dlb . '/' . $w_a_1_1_PHP_DIR_dlb_a . '/' ;
$DESTINA= $CARTELLA_NUOVA.$w_a_1_1_PHP_DIR_dlb   . '/' . $w_a_1_1_PHP_DIR_dlb_a . '/' ;
...
// secondo livello
// b
$w_a_1_1_PHP_DIR_dlb_b='b';

$ORIGINE= $CARTELLA_VECCHIA.$w_a_1_1_PHP_DIR_dlb . '/' . $w_a_1_1_PHP_DIR_dlb_b . '/' ;
$DESTINA= $CARTELLA_NUOVA.$w_a_1_1_PHP_DIR_dlb   . '/' . $w_a_1_1_PHP_DIR_dlb_b . '/' ;
...
echo '
<article class="ui red center aligned segment">
<div class="ui red button"><h1 style="font-variant:small-caps;"> Programma non eseguito  </h1></div>
</article>
';
...
release CREATY07_240128_1900a   : verde, nook, sparrow, sixties
 &copy; 2024
</q>
