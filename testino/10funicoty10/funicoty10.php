  ...
  .modal-backdrop {
    ...
    <div id="MODALE" style="overflow:auto;"  class="ui container">
        <div  style="width:99.5%; height:99.5%; background-color:transparent; color:black;"  class="ui basic modal">
            ...
            <a href="breaty10.php" style="text-decoration: none; text-decoration-thickness: 0px;"  class="ui primary inverted button">BACKUP</a>
...
echo '<a href="breaty10.php" style="text-decoration: none; text-decoration-thickness: 0px;" class="ui red inverted button">BACKUP</a>';
...
release FUNICOTY10_240218_1130a   : verde, nook, sparrow, sixties
 &copy; 2024
</q>
