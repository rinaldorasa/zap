...
echo '<form id="w_a_1_1_FORM_X_INVIA_AES__" action="funicoty05.php" method="POST">';
...
};  // ($w_a_1_1_FLAG_DI_LETTURA_FREE===1) ? y n
...
<blockquote id="thefamouslastwords" style="margin-top:0.5rem; margin-bottom:0.5rem; text-align:center; border:dotted 0.15rem purple; border-radius:0.50rem; box-shadow:6px 6px 12px transparent;">
...
release FUNICOTY05_240121_1900a   : verde, nook, sparrow, sixties
 &copy; 2024
</q>
