...
echo '<form id="w_a_1_1_FORM_X_INVIA_AES__" action="funicoty07.php" method="POST">';
...
<style>
  .modal-backdrop {
	...
	<div style="overflow:auto;"  class="ui container">
...
echo '<a href="https://www.rinaldo-rasa.it/funicoty07/index.html" class="ui red button">https</a>';
echo '</div>';
?>
</main>
...
release FUNICOTY07_240203_0815a   : verde, nook, sparrow, sixties
 &copy; 2024
</q>
...
<!-- et mahler 03620    -->  
<!-- notepad blackboard -->
<!-- http://server.com/pdfjs/web/viewer.html?file=http://server.com/test.pdf -->
<div id="fine"></div>
