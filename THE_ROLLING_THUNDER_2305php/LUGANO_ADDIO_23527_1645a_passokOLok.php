...
<!-- LUGANO_ADDIO_23527_0930a -->

<title>
!$
LUGANO_ADDIO_23527_0930a.html
...
ol li::before {  content: counter(ColoreCounter__) ". ";  background-color:initial;color: red;border:solid 0.15rem aqua;border-radius: 100%;display:inline-block;}
...
background-color:red;color:white;font-size:2.5rem;
border-radius:0.5rem;
cursor:pointer;
}
#APRI_HEADER__{
position:absolute;top:0rem;right:0rem;text-align:right;
background-color:green;color:white;font-size:2.5rem;
...
<button id="COPY_SI__" onclick="COPY_SI()">copy</button>
<button id="COPY_NO__" onclick="COPY_NO()">copy</button>
...
// document.querySelector("#MAIN__").style.marginTop="0";
...
if(DESKTOP_CHECK==1){ValoreInizialeRange__=25;}
...
<q style="font-size:0.75rem;">LUGANO_ADDIO_23527_0930a</q>
`;
