...
<!-- LUGANO_ADDIO_23529_1915a -->
<title>
#
LUGANO_ADDIO_23529_1915a.html
...
color:black;
border:solid 0.05rem rgb(85,25,225);
...
<q style="position:absolute;bottom:0rem;right:0rem;font-size:0.75rem;">TheRollingThunder vers. LUGANO_ADDIO_23529_1915a</q>
<hr>
</div>
...
#CHECK_STOP_AND_GO__{font-size:`+(FonteDinamica__*0.5)+`rem;}
...
`
<q>Versione <span style="background-color:red;color:white;">senza COPY</span> step07</q>

<q style="background-color:green;color:white;font-size:0.75rem;">LUGANO_ADDIO_23529_1915a</q>
...
<li>step07 ricordarsi di dare un nome a setInterval per lo stop-and-go</li>
<li></li>
