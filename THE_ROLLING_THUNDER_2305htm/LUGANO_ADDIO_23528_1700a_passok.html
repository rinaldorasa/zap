...
<!-- LUGANO_ADDIO_23528_1215a -->

<title>

#$%^*()

LUGANO_ADDIO_23528_1215a.html
...
<q style="position:absolute;bottom:0rem;right:0rem;font-size:0.75rem;">LUGANO_ADDIO_23528_1215a</q>
<hr>
</div>
...
//  `
// 
//  <input id="RANGER__" type="range" value="50" step="1" min="1" max="99">
// 
//  `;
// }; 
...
//
//
	LaSceltaInterattivaDinamica = NomeDelFileDaInput__;
...
document.getElementById("VISUALIZZA_TESTO_00__").innerHTML=`${TestoTrovatoDaLeggere}`; 
...
clearInterval(EsegueIntervalPrendeNomeFileDaInput_00);
document.querySelector("#COPY_SI__").style.display="none";
document.querySelector("#COPY_NO__").style.display="block";
}
...
`
<q style="font-size:0.75rem;">HeightHeader__=`+   HeightHeader__  +`</q>

<q style="font-size:0.75rem;">LUGANO_ADDIO_23528_1215a</q>
`;
