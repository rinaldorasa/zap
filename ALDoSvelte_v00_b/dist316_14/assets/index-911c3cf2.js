(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const l of o)if(l.type==="childList")for(const s of l.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&r(s)}).observe(document,{childList:!0,subtree:!0});function e(o){const l={};return o.integrity&&(l.integrity=o.integrity),o.referrerPolicy&&(l.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?l.credentials="include":o.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(o){if(o.ep)return;o.ep=!0;const l=e(o);fetch(o.href,l)}})();function v(){}function K(n){return n()}function G(){return Object.create(null)}function S(n){n.forEach(K)}function j(n){return typeof n=="function"}function F(n,t){return n!=n?t==t:n!==t||n&&typeof n=="object"||typeof n=="function"}function W(n){return Object.keys(n).length===0}function i(n,t){n.appendChild(t)}function J(n,t,e){n.insertBefore(t,e||null)}function V(n){n.parentNode&&n.parentNode.removeChild(n)}function p(n){return document.createElement(n)}function Q(n){return document.createTextNode(n)}function m(){return Q(" ")}function d(n,t,e){e==null?n.removeAttribute(t):n.getAttribute(t)!==e&&n.setAttribute(t,e)}function X(n){return Array.from(n.childNodes)}function y(n,t,e,r){e===null?n.style.removeProperty(t):n.style.setProperty(t,e,r?"important":"")}let D;function z(n){D=n}const h=[],U=[];let b=[];const H=[],tt=Promise.resolve();let B=!1;function nt(){B||(B=!0,tt.then(Y))}function k(n){b.push(n)}const x=new Set;let O=0;function Y(){if(O!==0)return;const n=D;do{try{for(;O<h.length;){const t=h[O];O++,z(t),et(t.$$)}}catch(t){throw h.length=0,O=0,t}for(z(null),h.length=0,O=0;U.length;)U.pop()();for(let t=0;t<b.length;t+=1){const e=b[t];x.has(e)||(x.add(e),e())}b.length=0}while(h.length);for(;H.length;)H.pop()();B=!1,x.clear(),z(n)}function et(n){if(n.fragment!==null){n.update(),S(n.before_update);const t=n.dirty;n.dirty=[-1],n.fragment&&n.fragment.p(n.ctx,t),n.after_update.forEach(k)}}function ot(n){const t=[],e=[];b.forEach(r=>n.indexOf(r)===-1?t.push(r):e.push(r)),e.forEach(r=>r()),b=t}const it=new Set;function rt(n,t){n&&n.i&&(it.delete(n),n.i(t))}function at(n,t,e,r){const{fragment:o,after_update:l}=n.$$;o&&o.m(t,e),r||k(()=>{const s=n.$$.on_mount.map(K).filter(j);n.$$.on_destroy?n.$$.on_destroy.push(...s):S(s),n.$$.on_mount=[]}),l.forEach(k)}function lt(n,t){const e=n.$$;e.fragment!==null&&(ot(e.after_update),S(e.on_destroy),e.fragment&&e.fragment.d(t),e.on_destroy=e.fragment=null,e.ctx=[])}function dt(n,t){n.$$.dirty[0]===-1&&(h.push(n),nt(),n.$$.dirty.fill(0)),n.$$.dirty[t/31|0]|=1<<t%31}function st(n,t,e,r,o,l,s,R=[-1]){const _=D;z(n);const a=n.$$={fragment:null,ctx:[],props:l,update:v,not_equal:o,bound:G(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(t.context||(_?_.$$.context:[])),callbacks:G(),dirty:R,skip_bound:!1,root:t.target||_.$$.root};s&&s(a.root);let P=!1;if(a.ctx=e?e(n,t.props||{},(c,g,...u)=>{const f=u.length?u[0]:g;return a.ctx&&o(a.ctx[c],a.ctx[c]=f)&&(!a.skip_bound&&a.bound[c]&&a.bound[c](f),P&&dt(n,c)),g}):[],a.update(),P=!0,S(a.before_update),a.fragment=r?r(a.ctx):!1,t.target){if(t.hydrate){const c=X(t.target);a.fragment&&a.fragment.l(c),c.forEach(V)}else a.fragment&&a.fragment.c();t.intro&&rt(n.$$.fragment),at(n,t.target,t.anchor,t.customElement),Y()}z(_)}class pt{$destroy(){lt(this,1),this.$destroy=v}$on(t,e){if(!j(e))return v;const r=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return r.push(e),()=>{const o=r.indexOf(e);o!==-1&&r.splice(o,1)}}$set(t){this.$$set&&!W(t)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}function ct(n){let t,e,r,o,l,s,R,_,a,P,c,g,u,f,I,T,L,A,w,N,$,E,C,Z;return{c(){t=p("main"),e=p("div"),e.textContent="program version 313_step130h 20:23:03:13:18:13",r=m(),o=p("div"),o.textContent="err APPLIC_AZIONE",l=m(),s=p("div"),s.textContent="⚠test",R=m(),_=p("script"),_.textContent=`let NodoText = "NodoText debugging for App313_step130h.svelte test20230316";
   ...
   let AltezzaPrimoPiano   = AltezzaApplicazione_Rem;
	...
	// 	alert("2023:03:16:09:22 debug TESTAPP ok!");
	}; // TESTAPP
	TESTAPP(NodoText);`,a=m(),P=p("style"),P.textContent=`main{
	...
	.hack_script{display:none;}`,c=m(),g=p("div"),u=p("input"),f=p("datalist"),I=p("option"),T=p("option"),L=m(),A=p("link"),w=m(),N=p("link"),$=m(),E=p("link"),C=m(),Z=p("link"),y(e,"position","fixed"),y(e,"bottom","0rem"),y(e,"left","25%"),y(e,"font-size","75%"),d(o,"id","APPLIC_AZIONE"),d(s,"id","test"),y(s,"display","none"),d(u,"type","range"),d(u,"step","1"),d(u,"min","1"),d(u,"max","2"),I.__value="1",I.value=I.__value,T.__value="2",T.value=T.__value,d(g,"class","hack_script"),d(A,"rel","preconnect"),d(A,"href","https://fonts.gstatic.com"),d(N,"href","https://fonts.googleapis.com/css2?family=PT+Mono&display=swap"),d(N,"rel","stylesheet"),d(E,"href","https://fonts.googleapis.com/css2?family=Rasa&display=swap"),d(E,"rel","stylesheet"),d(Z,"href","https://fonts.googleapis.com/css2?family=Dancing+Script&display=swap"),d(Z,"rel","stylesheet"),d(t,"id","MAIN")},m(M,q){J(M,t,q),i(t,e),i(t,r),i(t,o),i(t,l),i(t,s),i(t,R),i(t,_),i(t,a),i(t,P),i(t,c),i(t,g),i(g,u),i(g,f),i(f,I),i(f,T),i(t,L),i(t,A),i(t,w),i(t,N),i(t,$),i(t,E),i(t,C),i(t,Z)},p:v,i:v,o:v,d(M){M&&V(t)}}}class ut extends pt{constructor(t){super(),st(this,t,null,ct,F,{})}}new ut({target:document.getElementById("app")});
