(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&r(s)}).observe(document,{childList:!0,subtree:!0});function e(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(o){if(o.ep)return;o.ep=!0;const a=e(o);fetch(o.href,a)}})();function v(){}function U(n){return n()}function G(){return Object.create(null)}function E(n){n.forEach(U)}function j(n){return typeof n=="function"}function F(n,t){return n!=n?t==t:n!==t||n&&typeof n=="object"||typeof n=="function"}function W(n){return Object.keys(n).length===0}function i(n,t){n.appendChild(t)}function J(n,t,e){n.insertBefore(t,e||null)}function Y(n){n.parentNode&&n.parentNode.removeChild(n)}function p(n){return document.createElement(n)}function Q(n){return document.createTextNode(n)}function m(){return Q(" ")}function d(n,t,e){e==null?n.removeAttribute(t):n.getAttribute(t)!==e&&n.setAttribute(t,e)}function X(n){return Array.from(n.childNodes)}function z(n,t,e,r){e===null?n.style.removeProperty(t):n.style.setProperty(t,e,r?"important":"")}let $;function R(n){$=n}const h=[],H=[];let b=[];const K=[],tt=Promise.resolve();let k=!1;function nt(){k||(k=!0,tt.then(V))}function M(n){b.push(n)}const S=new Set;let O=0;function V(){if(O!==0)return;const n=$;do{try{for(;O<h.length;){const t=h[O];O++,R(t),et(t.$$)}}catch(t){throw h.length=0,O=0,t}for(R(null),h.length=0,O=0;H.length;)H.pop()();for(let t=0;t<b.length;t+=1){const e=b[t];S.has(e)||(S.add(e),e())}b.length=0}while(h.length);for(;K.length;)K.pop()();k=!1,S.clear(),R(n)}function et(n){if(n.fragment!==null){n.update(),E(n.before_update);const t=n.dirty;n.dirty=[-1],n.fragment&&n.fragment.p(n.ctx,t),n.after_update.forEach(M)}}function ot(n){const t=[],e=[];b.forEach(r=>n.indexOf(r)===-1?t.push(r):e.push(r)),e.forEach(r=>r()),b=t}const it=new Set;function rt(n,t){n&&n.i&&(it.delete(n),n.i(t))}function lt(n,t,e,r){const{fragment:o,after_update:a}=n.$$;o&&o.m(t,e),r||M(()=>{const s=n.$$.on_mount.map(U).filter(j);n.$$.on_destroy?n.$$.on_destroy.push(...s):E(s),n.$$.on_mount=[]}),a.forEach(M)}function at(n,t){const e=n.$$;e.fragment!==null&&(ot(e.after_update),E(e.on_destroy),e.fragment&&e.fragment.d(t),e.on_destroy=e.fragment=null,e.ctx=[])}function dt(n,t){n.$$.dirty[0]===-1&&(h.push(n),nt(),n.$$.dirty.fill(0)),n.$$.dirty[t/31|0]|=1<<t%31}function st(n,t,e,r,o,a,s,A=[-1]){const g=$;R(n);const l=n.$$={fragment:null,ctx:[],props:a,update:v,not_equal:o,bound:G(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(t.context||(g?g.$$.context:[])),callbacks:G(),dirty:A,skip_bound:!1,root:t.target||g.$$.root};s&&s(l.root);let P=!1;if(l.ctx=e?e(n,t.props||{},(u,_,...c)=>{const f=c.length?c[0]:_;return l.ctx&&o(l.ctx[u],l.ctx[u]=f)&&(!l.skip_bound&&l.bound[u]&&l.bound[u](f),P&&dt(n,u)),_}):[],l.update(),P=!0,E(l.before_update),l.fragment=r?r(l.ctx):!1,t.target){if(t.hydrate){const u=X(t.target);l.fragment&&l.fragment.l(u),u.forEach(Y)}else l.fragment&&l.fragment.c();t.intro&&rt(n.$$.fragment),lt(n,t.target,t.anchor,t.customElement),V()}R(g)}class pt{$destroy(){at(this,1),this.$destroy=v}$on(t,e){if(!j(e))return v;const r=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return r.push(e),()=>{const o=r.indexOf(e);o!==-1&&r.splice(o,1)}}$set(t){this.$$set&&!W(t)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}function ut(n){let t,e,r,o,a,s,A,g,l,P,u,_,c,f,y,T,L,I,D,Z,w,N,C,x;return{c(){t=p("main"),e=p("div"),e.textContent="program version 313_step130h 20:23:03:13:18:13",r=m(),o=p("div"),o.textContent="err APPLIC_AZIONE",a=m(),s=p("div"),s.textContent="⚠test",A=m(),g=p("script"),g.textContent=`let NodoText = "NodoText debugging for App313_step130h.svelte test20230316";
   ...
   let AltezzaPrimoPiano   = AltezzaApplicazione_Rem;
	...
	// 		alert("2023:03:16:09:17 debug TESTAPP ok!");
	}; // TESTAPP
	...
	.hack_script{display:none;}`,u=m(),_=p("div"),c=p("input"),f=p("datalist"),y=p("option"),T=p("option"),L=m(),I=p("link"),D=m(),Z=p("link"),w=m(),N=p("link"),C=m(),x=p("link"),z(e,"position","fixed"),z(e,"bottom","0rem"),z(e,"left","25%"),z(e,"font-size","75%"),d(o,"id","APPLIC_AZIONE"),d(s,"id","test"),z(s,"display","none"),d(c,"type","range"),d(c,"step","1"),d(c,"min","1"),d(c,"max","2"),y.__value="1",y.value=y.__value,T.__value="2",T.value=T.__value,d(_,"class","hack_script"),d(I,"rel","preconnect"),d(I,"href","https://fonts.gstatic.com"),d(Z,"href","https://fonts.googleapis.com/css2?family=PT+Mono&display=swap"),d(Z,"rel","stylesheet"),d(N,"href","https://fonts.googleapis.com/css2?family=Rasa&display=swap"),d(N,"rel","stylesheet"),d(x,"href","https://fonts.googleapis.com/css2?family=Dancing+Script&display=swap"),d(x,"rel","stylesheet"),d(t,"id","MAIN")},m(B,q){J(B,t,q),i(t,e),i(t,r),i(t,o),i(t,a),i(t,s),i(t,A),i(t,g),i(t,l),i(t,P),i(t,u),i(t,_),i(_,c),i(_,f),i(f,y),i(f,T),i(t,L),i(t,I),i(t,D),i(t,Z),i(t,w),i(t,N),i(t,C),i(t,x)},p:v,i:v,o:v,d(B){B&&Y(t)}}}class ct extends pt{constructor(t){super(),st(this,t,null,ut,F,{})}}new ct({target:document.getElementById("app")});
