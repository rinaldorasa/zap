...
<div class="ui two column very relaxed stackable grid">
    ...
    <div  style="border-right:dashed 0.15rem green;"  class="column">
      <form class="ui form" action="breaty10.php"  method="POST">
            <div class="field">
    ...
    <div class="column">
       ...
       <h6 style="color:olive;" class="ui center aligned segment">breaty10_240215_1300a</h6>
...
// echo '<br>' . 'DOVE_DESTINA_MODULI= ' .$DOVE_DESTINA_MODULI ;
...
echo '<table class="ui table">';
echo '<tr><td>';
echo '<span>ORIGINE: ' .'</span>'. ' <span class="ui red   label"> ' . $ORIGINE . '' . '</span>'  ;
echo '</td></tr>';
echo '<tr><td>';
echo '<span>DESTINA: ' .'</span>'. ' <span class="ui green label"> ' . $DESTINA . '' . '</span>'  ;
echo '</td></tr>';
echo '';
echo '</table>';
...
$ORIGINE_FIL_000_003=$ORIGINE.'breaty10.php';
$ORIGINE_FIL_000_004=$ORIGINE.'funicoty10.php';
...
$DESTINA_FIL_000_003=$DESTINA.'breaty10.php';
$DESTINA_FIL_000_004=$DESTINA.'funicoty10.php';
